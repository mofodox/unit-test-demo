...
func TestUse(t *testing.T) {
	...
	// gomock.InOrder(
	// 	mockDoer.EXPECT().DoSomething(1, "first this").Return(nil).Times(1),
	// 	mockDoer.EXPECT().DoSomething(2, "then this").Return(nil).Times(1),
	// 	mockDoer.EXPECT().DoSomething(3, "then this").Return(nil).Times(1),
	// 	mockDoer.EXPECT().DoSomething(4, "finally this").Return(nil).Times(1),
	// )

	// Specifying mock actions
	mockDoer.EXPECT().DoSomething(123, gomock.Any()).Return(nil).Do(func(x int, y string) {
